...
```{r}
gam <- gam(pa ~ Mean_durnal_temp_range + Isothermality + Mean_temp_wettest_q  +   Ann_.precip  +   Precip_driest_week       +      Precip_Seasonality   +   Precip_coldest_q    +   
Lowest_weekly_rad   +    Rad_driest_q      +      Moisture_seasonality      + Mean_moisture_warmest_q +   Elev +   human_impact,
