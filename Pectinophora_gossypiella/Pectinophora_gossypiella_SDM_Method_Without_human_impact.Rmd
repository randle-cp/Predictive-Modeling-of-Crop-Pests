---
title: "SDM_Method_Pectinophora_gossypiella_w/o_Human_Impact"
author: "Rhodes"
date: "6/20/2022"
...
USING DATA FROM HOME RANGE OF India, Pakistan
```{r}
sdmdata<-read.csv(file=paste0("Pectinophora_gossypiella_clean.csv"))
...
```{r}
gam <- gam(pa ~  Isothermality + Mean_temp_driest_q + Ann_.precip + Precip_driest_week + Precip_wettest_week + Precip_Seasonality + Precip_warmest_q + Precip_coldest_q + Ann_mean_rad + Lowest_weekly_moisture + Elev,                      
...
plot(me_model)
```
MOST IMPORTANT FACTORS ARE HUMAN IMPACT // ANNUAL_MEAN_RAD // PRECIP_WARMEST_Q // ELEV // PRECIP_DRIEST_WEEK
