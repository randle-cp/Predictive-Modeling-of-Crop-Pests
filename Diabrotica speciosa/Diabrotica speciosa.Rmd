...
```{r}
gam <- gam(pa ~ Mean_durnal_temp_range +  Isothermality      +      Mean_temp_wettest_q     + Ann_.precip       +       Precip_wettest_week  +    Precip_warmest_q   +      Precip_coldest_q    +    
Ann_mean_rad     +        Lowest_weekly_rad   +     Rad_driest_q    +         Highsets_weekly_moisture + Moisture_seasonality  +   Elev         +         human_impact,
