---
title: "SDM_Method_Oxycarenus_hyalinipennis"
...
```{r}
gam <- gam(pa ~  Mean_temp_warmiest_q+ Ann_.precip + Precip_driest_week + Precip_wettest_week + Rad_wettest_q + Rad_warmest_q + Mean_moisture_coldest_q + Elev + human_impact,                      
...
plot(me_model)
```
MOST IMPORTANT FACTORS ARE HUMAN IMPACT // RAD_WETTEST_Q // RAD_WARMEST_Q // ANN_PRECIP
