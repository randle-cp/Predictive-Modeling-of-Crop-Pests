...
```{r}
sdmdata <- read.csv(file = "Autographa gamma clean.csv")
...
```{r}
gam <- gam(pa ~ Mean_durnal_temp_range + Temp_Seasonality  +  MaxTemp_WarmestWeek   +Mean_temp_wettest_q +  Ann_.precip   +    Precip_Seasonality +  Precip_warmest_q + Hghest_weekly_rad +   Rad_driest_q   +   Rad_coldest_q  +    Moisture_seasonality +  Mean_moisture_coldest_q + Elev    +      human_impact ,
