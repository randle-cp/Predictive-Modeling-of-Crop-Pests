...
Using occurrence points from Asia (homerange).
```{r}
...
```{r}
gam <- gam(pa ~ Isothermality + Temp_Seasonality + MaxTemp_WarmestWeek + Mean_temp_wettest_q +    
Ann_.precip + Precip_driest_week + Precip_Seasonality + Hghest_weekly_rad + Lowest_weekly_rad + Rad_driest_q + Rad_warmest_q + Elev + human_impact                      ,
...
plot(me_model)
```
most important variables are hghest_weekly_rad, Elev, Ann_.precip, human_impact, and Temp_Seasonality
