...
3a. Note the points that fall outside the home range. There are two ways to deal with this. One is to create a file that can be examined in excel. To do this, substitute a name for the file in the following code. 
