...
```{r}
gam <- gam(pa ~  Mean_durnal_temp_range + Mean_temp_wettest_q + Precip_driest_week + Precip_Seasonality + Precip_coldest_q + Rad_driest_q + Isothermality + human_impact + Ann_.precip + Precip_wettest_week + Precip_warmest_q + Rad_seasonality,                      
