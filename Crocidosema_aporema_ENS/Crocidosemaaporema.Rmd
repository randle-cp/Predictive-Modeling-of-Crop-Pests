---
title: "SDM_Method_Crocidosemaaporema"
...
The species does not have enough occurrence points to give a reliable prediction model.
...
```{r}
sdmdata<-read.csv(file=paste0("Crocidosema_aporema_clean.csv"))
...
```{r}
gam <- gam(pa ~  Ann_.precip + Moisture_seasonality + Mean_moisture_wettest_q + Elev + human_impact,                      
...
plot(me_model)
```
MOST IMPORTANT FACTORS ARE HUMAN IMPACT // TEMP_SEAS // ANN_PRECIP // RAD_SEAS // ELEV // MEAN-MOIST COLD
