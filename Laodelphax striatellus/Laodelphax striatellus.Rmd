...
```{r}
gam <- gam(pa ~ Isothermality    +        Temp_Seasonality     +    MaxTemp_WarmestWeek  +    Ann_.precip      +        Precip_Seasonality   +    Precip_coldest_q     +    Hghest_weekly_rad   +    
Rad_wettest_q        +    Rad_driest_q     +        Highsets_weekly_moisture + Moisture_seasonality  +   Elev        +             human_impact,
