...
```{r}
gam <- gam(pa ~ Mean_durnal_temp_range + Isothermality   +       Mean_temp_warmiest_q   + Ann_.precip     +       Precip_Seasonality  +   Precip_warmest_q  +     Precip_coldest_q   +    Hghest_weekly_rad    + 
Rad_wettest_q     +     Rad_driest_q    +       Elev   +                human_impact,
