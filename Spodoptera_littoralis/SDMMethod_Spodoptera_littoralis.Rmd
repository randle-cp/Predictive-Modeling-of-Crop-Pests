---
title: "Spodoptera_littoralis_SDM_Method"
...
```{r}
gam <- gam(pa ~  Isothermality + Temp_Seasonality + Mean_temp_wettest_q + Ann_.precip + Precip_coldest_q + Hghest_weekly_rad + Rad_wettest_q + Rad_driest_q + Moisture_seasonality + Elev + human_impact,                      
...
plot(me_model)
```
MOST IMPORTANT FACTORS ARE HUMAN IMPACT // RAD_DRIEST_Q // ELEV // RAD_WETTEST_Q // TEMP_SEAS 
