---
title: "Spodoptera_littoralis_SDM_Method_Without_Human_Impact"
...
```{r}
sdmdata<-read.csv(file=paste0("Spodoptera_littoralis_clean.csv"))
...
```{r}
gam <- gam(pa ~  Isothermality + Temp_Seasonality + Mean_temp_wettest_q + Ann_.precip + Precip_wettest_week + Precip_coldest_q + Hghest_weekly_rad + Rad_wettest_q + Rad_driest_q + Moisture_seasonality + Elev,                      
...
plot(me_model)
```
MOST IMPORTANT FACTORS ARE ELEV // RAD_WETTEST_Q // TEMP_SEAS // PRECIP_COLDEST_Q
