...
Using data from home range stratified down to one place past decimal
```{r}
sdmdata<-read.csv(file=paste0("Chrysodeixis_chalcites_clean.csv"))
...
Note: You will not find boyce index in here. A png of the graph is in the folder
