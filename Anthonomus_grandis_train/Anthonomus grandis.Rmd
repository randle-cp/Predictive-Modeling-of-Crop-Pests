...
```{r}
sdmdata<-read.csv(file=paste0("Anthonomus_grandis_clean.csv"))
...
```{r}
gam <- gam(pa ~ Mean_durnal_temp_range + MaxTemp_WarmestWeek + Ann_.precip + Precip_wettest_week + Precip_Seasonality + Rad_wettest_q + Rad_coldest_q + Mean_moisture_warmest_q + Elev + human_impact,                      
